...
class JGPageController: JGBaseController {

      var pageStyle: JGPageStyle!
    ...
    convenience init(titles: [String] = [], vcs: [UIViewController] = [], pageStyle: JGPageStyle = .none) {
        self.init()
        self.titles = titles
        self.vcs = vcs
...
extension JGPageController: UIPageViewControllerDataSource, UIPageViewControllerDelegate {
