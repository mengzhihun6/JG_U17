...
class JGComicHeadCCell: JGBaseCollectionViewCell {
...
class JGComicHeader: UIView {
    ...
    private lazy var thmemView: UICollectionView = {
        ...
        tw.register(cellType: JGComicHeadCCell.self)
        return tw
    }()
...
extension JGComicHeader: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return themes?.count ?? 0
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(for: indexPath, cellType: JGComicHeadCCell.self)
