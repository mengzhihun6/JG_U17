...
class JGUpdateListController: JGBaseController {
    ...
    private lazy var tableView: UITableView = {
        ...
        tw.delegate = self
        tw.dataSource = self
        tw.register(cellType: JGUpdateListCell.self)
...
extension JGUpdateListController: UITableViewDelegate, UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return comicList.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(for: indexPath, cellType: JGUpdateListCell.self)
