...
let timeoutClosure = {(endpoint: Endpoint, closure: MoyaProvider<JGApi>.RequestResultClosure) -> Void in
...
let ApiProvider = MoyaProvider<JGApi>(requestClosure: timeoutClosure)
let ApiLoadingProvider = MoyaProvider<JGApi>(requestClosure: timeoutClosure, plugins: [LoadingPlugin])
